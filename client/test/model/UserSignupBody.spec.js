...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserSignupBody', function() {
      beforeEach(function() {
        instance = new Fmd.UserSignupBody();
      });

      it('should create an instance of UserSignupBody', function() {
        // TODO: update the code to test UserSignupBody
        expect(instance).to.be.a(Fmd.UserSignupBody);
      });
