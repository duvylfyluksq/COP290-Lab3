...
function App() {
  return (
    <div className="App">
      <UserProfile pfp={userpfp} username="duvylfyluksq" bio="Im a puppet on a string tracy island, time-traveling diamond cutter-shaped heartaches that come to find you four in some velvet morning years too late..." 
      interest1="Adventure" interest2="Adventure" interest3="Adventure" posts="424242" likes="424242" comments="424242"/>
